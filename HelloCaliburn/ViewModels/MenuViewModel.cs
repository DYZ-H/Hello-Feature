...
namespace HelloCaliburn.ViewModels
{
    class MenuViewModel:Screen
    {
        ...
        public MenuViewModel(INavigationService navigationService)
        {
            ...
            MessageBox.Show("新建Menu");
            Features = new BindableCollection<FeatureViewModel>
            {
                new FeatureViewModel("Binding Conventions", "Binding view model properties to your view.", typeof(BindingViewModel)),
                new FeatureViewModel("Action Conventions", "Wiring view events to view model methods.", typeof(BubbleViewModel)),
